<div id="sidebar" class="clr">
    <div id="text-15" class="widget widget_text">
        <h3><span class="widget-title">QQ空间</span></h3>
    ...
    <div id="tinsubscribe-2" class="widget widget_tinsubscribe">
        ...
        <span id="subscribe-span"> <input type="text" name="subscribe" id="subscribe" placeholder="" /><button id="subscribe" class="btn btn-success">订阅</button> <p id="subscribe-msg" style="display:none;margin-top:5px;margin-left:auto;margin-right:auto;font-size:12px;color:#f00;"></p> </span>
    </div>
    ...
    <div id="meta-3" class="widget widget_meta">
        ...
        <ul>
            <!-- <li><a href="{{ url('/admin/login')}}" target="_blank">登录</a></li> -->
