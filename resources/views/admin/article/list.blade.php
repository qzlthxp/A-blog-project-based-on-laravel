  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加','{{url('/admin/article/create')}}',600,400)"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        @foreach($arts as $v)
          <tr>
            ...
            <!-- <td></td> -->
            <td class="td-status">
              <span class="layui-btn layui-btn-normal layui-btn-mini">未加入推荐位</span></td>
            <td class="td-manage">
