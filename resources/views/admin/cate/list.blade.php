  ...
  <body class="layui-anim layui-anim-up">
    ...
    <div class="x-body">
      ...
      <xblock>
        ...
        <button class="layui-btn" onclick="x_admin_show('添加','{{url('/admin/cate/create')}}',600,400)"><i class="layui-icon"></i>添加</button>
      ...
      <table class="layui-table">
        ...
        @foreach($cate as $v)
          <tr>
            <td>
              <div class="layui-unselect layui-form-checkbox" lay-skin="primary" data-id='{{ $v->conf_id }}'><i class="layui-icon">&#xe605;</i></div>
            </td>
            <td>{{ $v->cate_id }}</td>
            <td>{{ $v->cate_name }}</td>
            <td>{{ $v->cate_title }}</td>
